package org.jiang.shpping.strategy.impl;

import com.aliyun.oss.OSS;
import com.aliyun.oss.OSSClientBuilder;
import org.jiang.shpping.config.OssConfigProperties;
...
public class OssUploadStrategyImpl extends AbstractUploadStrategyImpl {
    ...
    private OSS getOssClient() {
        return new OSSClientBuilder()
                .build(ossConfigProperties.getEndpoint(), ossConfigProperties.getAccessKeyId(), ossConfigProperties.getAccessKeySecret());
    }
